...
def nth_root(a, n):
    ...
    Args:
      ...
      n : root param
    """
    return int(gmpy2.floor(gmpy2.root(a, n)))
...
def egcd(x, y):
    ...
    Return:
      ...
      g    : gcd(x, y)
    """
    g, a, b = map(int, gmpy2.gcdext(x, y))
    return (a, b, g)
...
def gcd(*args):
    ...
    Return: GCD of *args
    """
    return int(reduce(lambda x, y: gmpy2.gcd(x, y), args[1:], args[0]))
